...
(function _(namespace, path, parent, inner) {
    ...
    default: {
        PTP: {
            Auth: {
                AuthCaptchaReq: {
                    '$': {"1":["need_sign","bool",false]}
                },
                AuthCaptchaRes: {
                    '$': {"1":["captcha","string",""],"2":["address","string",""],"3":["iv","bytes",[]],"4":["aad","bytes",[]],"5":["sign","bytes",[]],"6":["error","uint32",0]}
                },
                AuthLoginReq: {
            ...
            Common: {
                BuddyModifyAction: {
                    '@': {"BuddyModifyAction_nickname":1,"BuddyModifyAction_avatar":2,"BuddyModifyAction_sign_info":3,"BuddyModifyAction_user_name":4}
                },
                CID_AUTH: {
                ...
                CID_BUDDY: {
                    '@': {"CID_BuddyStatNotify":513,"CID_BuddyGetListReq":514,"CID_BuddyGetListRes":515,"CID_BuddyGetALLReq":516,"CID_BuddyGetALLRes":517,"CID_BuddyGetStatReq":518,"CID_BuddyGetStatRes":519,"CID_BuddyModifyReq":520,"CID_BuddyModifyRes":521,"CID_BuddyModifyNotify":522,"CID_BuddyModifyUpdatePair":523}
                },
                CID_FILE: {
                    '@': {"CID_FileImgUploadReq":1281,"CID_FileImgUploadRes":1282}
                },
                CID_GROUP: {
                ...
                ERR: {
                    '@': {"NO_ERROR":0,"E_SYSTEM":1,"E_GROUP_CREATE_PAIR_GROUP_MEMBER_SIE_INVALID":2,"E_GROUP_CREATE_PAIR_GROUP_NO_REG_USER":3,"E_GROUP_HAS_CREATED":4,"E_REASON_NO_ROUTE_SERVER":5,"E_REASON_NO_LOGIN_SERVER":6,"E_REASON_NO_DB_SERVER":7,"E_LOGIN_ERROR":8,"E_PB_PARSE_ERROR":9,"E_SWITCH_USER_NO_ONLINE":10,"E_USERNAME_EXISTS":11}
                },
                GroupInfo: {
                ...
                UserInfo: {
                    '$': {"1":["address","string",""],"2":["pub_key","bytes",[]],"3":["avatar","string",""],"4":["status","uint32",0],"5":["user_name","string",""],"6":["nick_name","string",""],"7":["sign_info","string",""],"8":["uid","uint32",0]}
                },
                UserStat: {
            ...
            File: {
                FileImgUploadReq: {
                    '$': {"2":["width","uint32",0],"3":["height","uint32",0],"4":["file_data","bytes",[]],"5":["file_type","string",""],"6":["file_group","string",""],"20":["attach_data","bytes",[]],"21":["auth_uid","uint32",0]}
                },
                FileImgUploadRes: {
            ...
            Group: {
                ...
                GroupCreateReq: {
                    '$': {"1":["group_idx","uint32",0],"2":["sign","bytes",[]],"3":["captcha","string",""],"4":["group_type","uint32",1],"5":["name","string",""],"6":["avatar","string",""],"7":["members","[uint32",null],"20":["attach_data","bytes",[]],"21":["auth_uid","uint32",0]}
                },
                GroupCreateRes: {
                ...
                GroupPreCreateRes: {
                    '$': {"1":["group_adr","string",""],"2":["group_idx","uint32",0],"3":["error","uint32",0],"20":["attach_data","bytes",[]],"21":["auth_uid","uint32",0]}
                },
